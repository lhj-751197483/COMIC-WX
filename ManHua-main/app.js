...
App({
  ...
  globalData: {
    ...
    comicInfoBodyApi: 'https://comic.321mh.com/app_api/v5/getcomicinfo_body',
    ...
    comicInfoSearchApi:'https://www.kanman.com/api/getsortlist',
    topSearchApi:'https://www.kanman.com/api/gettopsearch',
    rankApi:'https://cms-webapi.321mh.com/api/v1/web/getRankDataForWeb',
    allClassifyApi:'https://cms-webapi.321mh.com/api/v1/web/getAllClassify',
    sortApi:'https://cms-webapi.321mh.com/api/v1/web/getsortlist'
  }
});
